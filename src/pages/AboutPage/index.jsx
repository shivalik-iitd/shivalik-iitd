...
const AboutPage = () => {
	return (
		<Page path="/about" className="about-page">
			...
			The legendary Shivalik has one of the richest cultures in drama, fine arts, literature, and other non-academic pursuits, among all other hostels, corroborated by the fact that we have been the winners of the BSP trophy and BRCA cup multiple times throughout the years. 
				<br />
				<br />
